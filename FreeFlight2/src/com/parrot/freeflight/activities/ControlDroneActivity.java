...
//            forceCombinedControlMode = false;
    ...
    private void initListeners()
    {
        ...
        view.setBtnCustomClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				if (droneControlService != null) {
					droneControlService.triggerFlip();
					Log.d(TAG, "FLIP");	
				}
			}
		});
        
        view.setBtnFlyInCircleClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				if (droneControlService != null) {
					
					droneControlService.flyInCircle();
					
					Log.d(TAG, "Fly in circle");	
				}
			}
		});
    }
