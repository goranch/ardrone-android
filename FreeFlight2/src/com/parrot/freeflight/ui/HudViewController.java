			   ...
			   OnGestureListener
{
	...
	private static final int CUSTOM_BTN_ID = 20;
	private static final int FLY_IN_CIRCLE = 21;
...
//			root.addView(canvasView, 0);
		...
		btnCustom = new Button(res, R.drawable.back_btn_settings_normal, R.drawable.back_btn_settings_pressed, Align.BOTTOM_RIGHT);
		btnFlyInCircle = new Button(res, R.drawable.back_btn_settings_normal, R.drawable.back_btn_settings_normal, Align.BOTTOM_LEFT);
		...
		renderer.addSprite(CUSTOM_BTN_ID, btnCustom);
		renderer.addSprite(FLY_IN_CIRCLE, btnFlyInCircle);
	...
	public void setBtnCustomClickListener(OnClickListener listener){
		this.btnCustom.setOnClickListener(listener);
	}
	
	public void setBtnFlyInCircleClickListener(OnClickListener listener){
		this.btnFlyInCircle.setOnClickListener(listener);
	}
